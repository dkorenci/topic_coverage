...
def plotThemeCounts(cohCounts, rndCounts, maxx=None, figid='plotThemeCounts',
                    palette=['b', 'k', 'g', 'y', 'c', 'm'],
                    labels=['graph1', 'graph2', 'baseline', 'word coherence']):
    from matplotlib import pyplot as plt
    import numpy as np
    fig, axes = plt.subplots(1, 2 , figsize = (20, 11.25))
    ...
    #axes[0].set_xlabel('topics examined', fontsize=20)
    #axes[0].set_ylabel('topics discovered', fontsize=20)
    ...
    #axes[1].set_xlabel('topics examined', fontsize=20)
