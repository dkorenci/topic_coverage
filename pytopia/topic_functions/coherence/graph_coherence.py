...
class GraphCoherence(IdComposer):
    ...
    def __init__(self, selector, mapper, metric, weightFilter=None,
        ...
        # todo extract from TES functionality for composing matrix into separate class
        self.__tes = TopicElementsScore(selector, mapper, None, mapperIsFactory)
...
def centerMeasure(values, measure):
    ...
    '''
    # todo separate centrality index from center measure, or remove it
