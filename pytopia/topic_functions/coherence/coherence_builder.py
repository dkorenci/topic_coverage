...
# todo name - CoherenceFactory ?
# todo pariwise word2vec (word embedding) coherence - generalize from DocCoherenceScorer
class CoherenceBuilder(IdComposer):
    '''
    ...
    def __palmettoScorer(self):
        ...
        if 'standard' in self.__p and self.__p['standard'] == True:
            ...
            self.__p['wordTransform'] = itok
        coh = PalmettoCoherence(self.type, topWords=self.topWords, **self.__p)
        self.__scorer = coh
