class BaseContext():
    '''
    Defines interface and implements basic functionality.
    Context-like must implement __getitem__, __contains__, and id property,
        as well as python context behaviour via __enter__ and __exit__
        that should push/pop this to GlobalContext.
    '''
    ...
    # todo: remove contains from the interface
