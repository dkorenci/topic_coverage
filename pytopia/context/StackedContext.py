...
class StackedContext(BaseContext):
    '''
    Stack data structure that contains contexts,
    resolution of ids is attempted from contained contexts,
    starting from the top of the stack and progressing to bottom.
    '''
